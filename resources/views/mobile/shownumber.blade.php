					...
					<tbody>
						<tr>
							...
							<td align="center" colspan="2">
								{{__('share')}}:
								<a href="https://wa.me/?text={{ asset($path) }}/{{$number->imgname}}" class="btn">
								<img src="{{asset('site-asset/img/whatsapp.png')}}" class="img-responsive" alt="emiratesnumber.com mobile number">	
								</a>
							</td>
						</tr>
						<tr>
							<td align="center" style="padding-top: 5px" colspan="2">
								<a href="{{ asset($path) }}/{{$number->imgname}}" class="btn btn-success btn-block" download >{{__('download')}}</a>
							</td>
						</tr>
						<tr>
							<td align="right"> {{__('seller')}}</td>
							<td align="center">
								<a href="{{url('/seller')}}/{{$number->user->profile}}">{{$number->user->name}}</a>
							</td>

						</tr>
						<tr>
							<td align="right"> {{__('price')}}</td>
							<td align="center">
